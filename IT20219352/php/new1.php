...
<img src = "../images/avatarplaceholder.png" alt = "Avatar" id = "avatar">
	...
	<table  width="100%" bgcolor="#f2f2f2" border="15" >
			<tr >
				...
				<th class="th1"><span class="rtext2">      Review      <span></th>
		...
		<?php
			...
			if ($result->num_rows>0){
				...
				echo"<tr><td><br><br>".$row["review_ratingID"]."</td>
						<td><br><br>".$row["username"]."</td>
						<td><br><br>".$row["Review"]."</td>
						<td><br><br>".$row["Rating"]."</td>
						<td><a href='deleteitems1.php?id=$id' >Delete</a></td>
