	...
	<body>
		...
		<h6>WOWme team is ready to answer any of your questions in no time</h6>
			<form method = 'post' action="feedback12.php" name="myForm3" onsubmit="return validateForm3()">
				...
				<label>Feedback ID: </label><input type="text" name = 'id' id = "form1" value = <?php echo $id?>><br><br>
				
				<label>Name		  : </label><input placeholder="Enter your name" type="text" name="iname" id = "form1" value = <?php echo $name?> pattern = "[A-Za-z]{3,10}" ><br><br>
				
				<label>E-mail	  : </label><input placeholder="Enter your email" type="text" name="email" id = "form1" value = <?php echo $email?> pattern = "[a-z0-9._%+-]+@[a-x0-9.-]+\.[a-z]{2,3}" ><br><br>
									
				<input type = "submit" id = "submit1" value = "Update"><button id = "submit1"><a href = "feedback.php">Confirm name and email</a></button><br><br>
